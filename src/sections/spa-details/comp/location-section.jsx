...
export default function LocationSection() {
  return (
    <div className="flex flex-col md:flex-row gap-8 items-start py-8 max-w-6xl mx-auto">
      {/* Map */}
      <motion.div
      ...
      {/* Info */}
      <motion.div
        className="bg-primary w-full md:w-1/2 p-8 rounded-lg"
      ...
      >
        <div className="text-gray-800 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-base font-extrabold">100 CHEMIN DE LA CHAPELLE 42300 VILLEREST</p>
          </div>
          <div className="flex items-start gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-base font-extrabold">+33 (0)4 77 23 01 98</p>
          </div>
          <div className="flex items-start gap-3">
            <FaEnvelope className="text-secondary mt-1" />
            <p className="text-base font-extrabold">CONTACT@DAVIDGRANDSPA.FR</p>
          </div>
        </div>
      </motion.div>
    </div>
